...
namespace Plugin.Cards
{
    public static class ActionFactory
    {
        public static bool SimpleAttack(
            ICard attackCard, ICard defenceCard, AttackEnum attack, DefenceEnum defence)
        {
        ...
        public static bool FeatureAttack13(
            ICard attackCard, IEnumerable<ICard> defenceCards, AttackEnum attack, DefenceEnum defence)
        {
        ...
        private static bool DistanceAcceptable(ICard card1, ICard card2, int distance = 1)
        {

...
public class Enemy : MonoBehaviour,IPlayer {
    ...
    string pathToCoinPositionEnemy = @"Assets\Scripts\PositionsOfCoinsEnemy.txt";
    public Player player
    {
        get { return _playerUnity.player; }
        set {
            _playerUnity.player = value;
            _playerUnity.Initialization(_positionsCards, _positionHero, pathToCreaturePositionEnemy,pathToCoinPositionEnemy);
